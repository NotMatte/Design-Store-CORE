    ...
    async execute(client, message) {
        ...
        const updateEmbed = new EmbedBuilder()
            .setTitle("⚡ Ci sono novità nel tuo ordine")
             .setDescription("Ti informiamo che "+ message.user.username +" ha iniziato a lavorare al tuo ordine,\ndi solito per lavori di normale difficoltà il tempo necessario varia \nalle **2/6 ore** mentre per lavori più semplici anche sono **1 ora**.\n\nTi ricordiamo che puoi sempre monitorare lo stato del tuo\nordine attraverso il comando `/ordine info "+cliente.username +"`.")
            .setColor(0xffbc58)
            .setFooter({ text: "Inoltrato da " + message.user.tag + "", iconURL: "https://i.imgur.com/wKKtFXA.png"})
            .setTimestamp();
